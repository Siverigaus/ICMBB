...
По одному `.conf` и одному `.out` на каждую систему (суффикс `3` у `.conf` и `.out` — версия конфига).

- `MD_2_bonds_W_I_PMm_100_ns_3.conf` / `MD_2_bonds_W_I_PMm_100_ns_3.out`
- `MD_303_350_W_I_PMm_100_ns_3.conf` / `MD_303_350_W_I_PMm_100_ns_3.out`
- `MD_no_bonds_W_I_PMm_100_ns_3.conf` / `MD_no_bonds_W_I_PMm_100_ns_3.out`

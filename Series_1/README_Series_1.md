...
Для каждого запуска присутствуют парные файлы `<базовое_имя>_[N].conf` и `<базовое_имя>_[N].out`,
...
```
MD_<система>_W_I_PMm_100_ns_[N].conf
MD_<система>_W_I_PMm_100_ns_[N].out
```
